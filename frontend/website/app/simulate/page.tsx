...
export default function Simulate() {
    ...
    const [merchant, setMerchant] = useState('0x1234567890123456789012345678901234567890');
    ...
    const handleSimulate = async () => {
        if (!isRegisteredAgent) {
            alert("Error: You must be connected with an Agent's Wallet to initiate a transaction.");
            return;
        }
                ...
                <div className="bg-white border-2 border-primary/10 rounded-[2.5rem] p-10 shadow-xl space-y-8 relative overflow-hidden">
                    ...
                    <div className="space-y-6 relative z-10">
                        ...
                        <button
                            ...
                            disabled={!isRegisteredAgent || isLoading}
