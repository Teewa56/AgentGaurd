    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-2xl shadow-lg border">
                ...
                <div className='p-2 text-white bg-blue-500 text-xs font-bold rounded-lg'>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                        <Link href="/auth/login" className="text-sm font-medium text-gray-600 hover:text-black">
